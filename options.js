...
const checkClearPreviousForBrowser = document.querySelector("#clearPreviousTabsCheckBoxForBrowser");
...
const checkMoveAllRightForBrowser = document.querySelector("#moveAllRightCheckBoxForBrowser");
...
const checkMoveAllLeftForBrowser = document.querySelector("#moveAllLeftCheckBoxForBrowser");
...
const checkPrintPreviewForBrowser = document.querySelector("#printPreviewCheckBoxForBrowser");
...
const checkPrintPageForBrowser = document.querySelector("#printPageCheckBoxForBrowser");
...
const checkSortTabsUrlAscForBrowser = document.querySelector("#sortTabsUrlAscCheckBoxForBrowser");
...
const checkSortTabsUrlDesForBrowser = document.querySelector("#sortTabsUrlDesCheckBoxForBrowser");
...
const checkSortTabsTitleAscForBrowser = document.querySelector("#sortTabsTitleAscCheckBoxForBrowser");
...
const checkSortTabsTitleDesForBrowser = document.querySelector("#sortTabsTitleDesCheckBoxForBrowser");
...
const checkSortTabsAccessedAscForBrowser = document.querySelector("#sortTabsAccessedAscCheckBoxForBrowser");
...
const checkSortTabsAccessedDesForBrowser = document.querySelector("#sortTabsAccessedDesCheckBoxForBrowser");
...
const checkCloseDuplicateTabsForBrowser = document.querySelector("#closeDuplicateTabsCheckBoxForBrowser");
...
const checkDiscardAllForBrowser = document.querySelector("#discardAllCheckBoxForBrowser");
...
const checkDiscardAllRightForBrowser = document.querySelector("#discardAllRightCheckBoxForBrowser");
...
const checkDiscardAllLeftForBrowser = document.querySelector("#discardAllLeftCheckBoxForBrowser"); 
...
const checkCombineAllRightForBrowser = document.querySelector("#combineAllRightCheckBoxForBrowser");
...
const checkCombineAllForBrowser = document.querySelector("#combineAllCheckBoxForBrowser");
...
const checkCombineAllLeftForBrowser = document.querySelector("#combineAllLeftCheckBoxForBrowser");
    ...
    switch(c.target.id){
        ...
        case "moveAllRightCheckBoxForDisable":
            await Storage.set({
                ...
                showMoveAllRightForBrowser: !checkMoveAllRightForDisable.checked
            });
            ...
            checkMoveAllRightForBrowser.checked = !checkMoveAllRightForDisable.checked;
            break;
        ...
        case "moveAllRightCheckBoxForBrowser":
            await Storage.set({
                showMoveAllRightForBrowser: checkMoveAllRightForBrowser.checked,
                checkMoveAllRightForDisable: false
            });
            checkMoveAllRightForDisable.checked = false;
            break;
        ...
        case "moveAllLeftCheckBoxForDisable":
            await Storage.set({
                ...
                showMoveAllLeftForBrowser: !checkMoveAllLeftForDisable.checked
            });
            ...
            checkMoveAllLeftForBrowser.checked = !checkMoveAllLeftForDisable.checked;
            break;
        ...
        case "MoveAllLeftCheckBoxForBrowser":
            await Storage.set({
                showMoveAllLeftForBrowser: checkMoveAllLeftForBrowser.checked,
                showMoveAllLeftForDisable: false
            });
            checkMoveAllLeftForDisable.checked = false;
            break;
        ...
        case "printPageCheckBoxForDisable":
            await Storage.set({
                ...
                showPrintPageForBrowser: !checkPrintPageForDisable.checked
            });
            ...
            checkPrintPageForBrowser.checked = !checkPrintPageForDisable.checked;
            break;
        ...
        case "printPageCheckBoxForBrowser":
            await Storage.set({
                showPrintPageForBrowser: checkPrintPageForBrowser.checked,
                showPrintPageForDisable: false
            });
            checkPrintPageForDisable.checked = false;
            break;
        ...
        case "printPreviewCheckBoxForDisable":
            await Storage.set({
                ...
                showPrintPreviewForBrowser: !checkPrintPreviewForDisable.checked
            });
            ...
            checkPrintPreviewForBrowser.checked = !checkPrintPreviewForDisable.checked;
            break;
        ...
        case "printPreviewCheckBoxForBrowser":
            await Storage.set({
                showPrintPreviewForBrowser: checkPrintPreviewForBrowser.checked,
                showPrintPreviewForDisable: false
            });
            checkPrintPreviewForDisable.checked = false;
            break;
        ...
        case "sortTabsAccessedDesCheckBoxForDisable":
            ...
            checkSortTabsAccessedDesForBrowser.checked = !checkSortTabsAccessedDesForDisable.checked;
            break;
        ...
        case "sortTabsAccessedDesCheckBoxForBrowser":
            await Storage.set({
                showSortTabsAccessedDesForBrowser: checkSortTabsAccessedDesForBrowser.checked,
                showSortTabsAccessedDesForDisable: false
            });
            checkSortTabsAccessedDesForDisable.checked = false;
            break;
        ...
        case "sortTabsAccessedAscCheckBoxForDisable":
            ...
            checkSortTabsAccessedAscForBrowser.checked = !checkSortTabsAccessedAscForDisable.checked;
            break;
        ...
        case "sortTabsAccessedAscCheckBoxForBrowser":
            await Storage.set({
                showSortTabsAccessedAscForBrowser: checkSortTabsAccessedAscForBrowser.checked,
                showSortTabsAccessedAscForDisable: false
            });
            checkSortTabsAccessedAscForDisable.checked = false;
            break;
        ...
        case "sortTabsTitleDesCheckBoxForDisable":
            ...
            checkSortTabsTitleDesForBrowser.checked = !checkSortTabsTitleDesForDisable.checked;
            break;
        ...
        case "showTabsTitleDesCheckBoxForBrowser":
            await Storage.set({
                showSortTabsTitleDesForBrowser: checkSortTabsTitleDesForBrowser.checked,
                showSortTabsTitleDesForDisable: false
            });
            checkSortTabsTitleDesForDisable.checked = false;
            break;
        ...
        case "sortTabsTitleAscCheckBoxForDisable":
            ...
            checkSortTabsTitleAscForBrowser.checked = !checkSortTabsTitleAscForDisable.checked;
            break;
        ...
        case "sortTabsTitleAscCheckBoxForBrowser":
            await Storage.set({
                showSortTabsTitleAscForBrowser: checkSortTabsTitleAscForBrowser.checked,
                showSortTabsTitleAscForDisable: false
            });
            checkSortTabsTitleAscForDisable.checked = false;
            break;
        ...
        case "sortTabsUrlDesCheckBoxForDisable":
            ...
            checkSortTabsUrlDesForBrowser.checked = !checkSortTabsUrlDesForDisable.checked;
            break;
        ...
        case "sortTabsUrlDesCheckBoxForBrowser":
            await Storage.set({
                showSortTabsUrlDesCheckBoxForBrowser: checkSortTabsUrlDesForBrowser.checked,
                showSortTabsUrlDesForDisable: false
            });
            checkSortTabsUrlDesForDisable.checked = false;
            break;
        ...
        case "sortTabsUrlAscCheckBoxForDisable":
            await Storage.set({
                ...
                showSortTabsUrlAscForBrowser: !checkSortTabsUrlAscForDisable.checked,
            });
            ...
            checkSortTabsUrlAscForBrowser.checked = !checkSortTabsUrlAscForDisable.checked;
            break;
        ...
        case "sortTabsUrlAscCheckBoxForBrowser":
            await Storage.set({
                showSortTabsUrlAscForBrowser: checkSortTabsUrlAscForBrowser.checked,
                showSortTabsUrlAscForDisable: false
            });
            checkSortTabsUrlAscForDisable.checked = false;
            break;
        ...
        case "savePdfCheckBoxForDisable":
            await Storage.set({
                ...
                showSavePdfForBrowser: !checkSavePdfForDisable.checked,
            ...
            checkSavePdfForBrowser.checked = !checkSavePdfForDisable.checked;
            break;

        case "savePdfCheckBoxForBrowser":
            await Storage.set({
                showSavePdfForBrowser: checkSavePdfForBrowser.checked,
        ...
        case "closeDuplicateTabsCheckBoxForDisable":
            await Storage.set({
                ...
                showCloseDuplicateTabsForBrowser: !checkCloseDuplicateTabsForDisable.checked,
            ...
            checkCloseDuplicateTabsForBrowser.checked = !checkCloseDuplicateTabsForDisable.checked;
            break;

        case "closeDuplicateTabsCheckBoxForBrowser":
            await Storage.set({
                showCloseDuplicateTabsForBrowser: checkCloseDuplicateTabsForBrowser.checked,
        ...
        case "closeAllLeftCheckBoxForDisable":
            await Storage.set({
                ...
                showCloseAllLeftForBrowser: !checkCloseAllLeftForDisable.checked
            });
        ...
        case "clearPreviousTabsCheckBoxForDisable":
            await Storage.set({
                ...
                showClearPreviousTabsForBrowser: !checkClearPreviousForDisable.checked,
            ...
            checkClearPreviousForBrowser.checked = !checkClearPreviousForDisable.checked;
            break;

        case "clearPreviousTabsCheckBoxForBrowser":
            await Storage.set({
                showClearPreviousTabsForBrowser: checkClearPreviousForBrowser.checked,
        ...
        case "discardAllCheckBoxForDisable":
            await Storage.set({
                ...
                showDiscardAllForBrowser: !checkDiscardAllForDisable.checked,
            ...
            checkDiscardAllForBrowser.checked = !checkDiscardAllForDisable.checked;
            break;
        
        case "discardAllRightCheckBoxForDisable":
            await Storage.set({
                showDiscardAllRightForDisable: checkDiscardAllRightForDisable.checked,
                showDiscardAllRightForBrowser: !checkDiscardAllRightForDisable.checked,
            ...
            checkDiscardAllRightForBrowser.checked = !checkDiscardAllRightForDisable.checked;
            break;

        case "discardAllLeftCheckBoxForDisable":
            await Storage.set({
                showDiscardAllLeftForDisable: checkDiscardAllLeftForDisable.checked,
                showDiscardAllLeftForBrowser: !checkDiscardAllLeftForDisable.checked,
            ...
            checkDiscardAllLeftForBrowser.checked = !checkDiscardAllLeftForDisable.checked;
            break;
        ...
        case "discardAllCheckBoxForBrowser":
            await Storage.set({
                showDiscardAllForBrowser: checkDiscardAllForBrowser.checked,
                showDiscardAllForDisable: false
            });
            checkDiscardAllForDisable.checked = false;
            break;

        case "discardAllRightCheckBoxForBrowser":
            await Storage.set({
                showDiscardAllRightForBrowser: checkDiscardAllRightForBrowser.checked,
                showDiscardAllRightForDisable: false
            });
            checkDiscardAllRightForDisable.checked = false;
            break;

        case "discardAllLeftCheckBoxForBrowser":
            await Storage.set({
                showDiscardAllLeftForBrowser: checkDiscardAllLeftForBrowser.checked,
                showDiscardAllLeftForDisable: false
            });
            checkDiscardAllLeftForDisable.checked = false;
            break;
        ...
        case "combineAllCheckBoxForDisable":
            await Storage.set({
                ...
                showCombineAllForBrowser: !checkCombineAllForDisable.checked,
                showCombineAllForPage: !checkCombineAllForDisable.checked,
                showCombineAllForTab: !checkCombineAllForDisable.checked
            });
            checkCombineAllForBrowser.checked = !checkCombineAllForDisable.checked;
        ...
        case "combineAllRightCheckBoxForDisable":
            await Storage.set({
                ...
                showCombineAllRightForBrowser: !checkCombineAllRightForDisable.checked,
            ...
            checkCombineAllRightForBrowser.checked = !checkCombineAllRightForDisable.checked;
        ...
        case "combineAllLeftCheckBoxForDisable":
            await Storage.set({
                ...
                showCombineAllLeftForBrowser: !checkCombineAllLeftForDisable.checked,
            ...
            checkCombineAllLeftForBrowser.checked = !checkCombineAllLeftForDisable.checked;
        ...
        case "combineAllCheckBoxForBrowser":
            await Storage.set({
                showCombineAllForBrowser: checkCombineAllForBrowser.checked,
                showCombineAllForDisable: false
            });
            checkCombineAllForDisable.checked = false;
            break;
        
        case "combineAllRightCheckBoxForBrowser":
            await Storage.set({
                showCombineAllRightForBrowser: checkCombineAllRightForBrowser.checked,
                showCombineAllRightForDisable: false
            });
            checkCombineAllRightForDisable.checked = false;
            break;
        
        case "combineAllLeftCheckBoxForBrowser":
            await Storage.set({
                showCombineAllLeftForBrowser: checkCombineAllLeftForBrowser.checked,
...
function init(){
    [
        ...
        "sortTabsTitleAscCheckBoxForBrowserLabel",
        ...
        "sortTabsTitleDesCheckBoxForBrowserLabel",
        ...
        "sortTabsUrlAscCheckBoxForBrowserLabel",
        ...
        "sortTabsUrlDesCheckBoxForBrowserLabel",
        ...
        "sortTabsAccessedAscCheckBoxForBrowserLabel",
        ...
        "closeDuplicateTabsCheckBoxForBrowserLabel",
        ...
        "discardAllCheckBoxForBrowserLabel",
        ...
        "discardAllLeftCheckBoxForBrowserLabel",
        ...
        "combineAllLeftCheckBoxForBrowserLabel",
        ...
        "combineAllRightCheckBoxForBrowserLabel",
    ...
    checkMoveAllRightForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkMoveAllLeftForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkPrintPageForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkPrintPreviewForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkSortTabsUrlAscForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkSortTabsUrlDesForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkSortTabsTitleAscForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkSortTabsTitleDesForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkSortTabsAccessedAscForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkSortTabsAccessedDesForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkCloseDuplicateTabsForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkDiscardAllLeftForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkDiscardAllForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkDiscardAllRightForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkCombineAllForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkCombineAllRightForBrowser.addEventListener("change", checkBoxChanged);
    ...
    checkCombineAllLeftForBrowser.addEventListener("change", checkBoxChanged);
...
function loadOptions(){
    Storage.get().then((result) => {
        ...
        checkMoveAllRightForBrowser.checked = result.showMoveAllRightForBrowser;
        ...
        checkMoveAllLeftForBrowser.checked = result.showMoveAllLeftForBrowser;
        ...
        checkPrintPageForBrowser.checked = result.showPrintPageForBrowser;
        ...
        checkPrintPreviewForBrowser.checked = result.showPrintPreviewForBrowser;
        ...
        checkSortTabsUrlAscForBrowser.checked = result.showSortTabsUrlAscForBrowser;
        ...
        checkSortTabsUrlDesForBrowser.checked = result.showSortTabsUrlDesForBrowser;
        ...
        checkSortTabsTitleAscForBrowser.checked = result.showSortTabsTitleAscForBrowser;
        ...
        checkSortTabsTitleDesForBrowser.checked = result.showSortTabsTitleDesForBrowser;
        ...
        checkSortTabsAccessedAscForBrowser.checked = result.showSortTabsAccessedAscForBrowser;
        ...
        checkSortTabsAccessedDesForBrowser.checked = result.showSortTabsAccessedDesForBrowser;
        ...
        checkSavePdfForBrowser.checked = result.showSavePdfForBrowser;
        ...
        checkCloseDuplicateTabsForBrowser.checked = result.showCloseDuplicateTabsForBrowser;
        ...
        checkDiscardAllForBrowser.checked = result.showDiscardAllForBrowser;
        ...
        checkDiscardAllRightForBrowser.checked = result.showDiscardAllRightForBrowser;
        ...
        checkDiscardAllLeftForBrowser.checked = result.showDiscardAllLeftForBrowser;
        ...
        checkCombineAllForBrowser.checked = result.showCombineAllForBrowser;
        ...
        checkCombineAllRightForBrowser.checked = result.showCombineAllRightForBrowser;
        ...
        checkCombineAllLeftForBrowser.checked = result.showCombineAllLeftForBrowser;
    });
}
